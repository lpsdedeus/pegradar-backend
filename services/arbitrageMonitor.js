        ...
        for (const token of filtered) {
          try {
            ...
            if (pctGain > 0.3) {
              ...
              console.log(`💸 Vender em: ${toChain}`);
              console.log(`📈 Lucro estimado: ${pctGain.toFixed(2)}%`);
              console.log(`🧾 Contrato origem: ${token.address}`);
              console.log(`🧾 Contrato destino: ${token.address}`);
              console.log('----------------------------');
            }
          } catch (e) {
